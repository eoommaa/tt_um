...
Take the output of port io_out[0] and feed it back into the chip (after transmitting it if you like). iio_out[1] will be zero after 31 clock cycles if the data is correct.

You can also capture the data and check it against the code at the end of the [Colab code](https://colab.research.google.com/drive/1uSGfoFdt0cDL9Ya7yrQQEXQ4FVlEGef5?usp=drive_link).
